...
<div x-data="setup()" :class="{ 'dark': isDark }">
  <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
      <!-- Add Promo Form -->
      <div class="m-4">
          <h1 class="font-bold text-xl p-4">ADD PROMO</h1>
            ...
            <div class="p-6">
              <form action="addpromo.ad" method="POST">
                  ...
                  <div class="w-full px-3 sm:w-1/2">
                    ...
                    <div class="flex items-center space-x-6">
                      <div class="flex items-center">
                        <input @click="open= true" type="radio" name="radio1" id="radioButton1" class="h-5 w-5"/>
                ...
                <div class="mb-5">
                  ...
                  <input type="number" name="value" id="value" placeholder="5" min="0" max="50" class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                </div>
