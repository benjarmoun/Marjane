...
<%--                            <span class="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-blue-500 bg-indigo-50 rounded-full">New</span>--%>
                    ...
                    <li>
                        <a href="addrespray.ad" class="relative flex flex-row items-center h-11 focus:outline-none bg-blue-800 dark:bg-gray-600  hover:text-white-800 border-l-4 border-transparent border-blue-500 dark:border-gray-800 pr-6">
                            <span class="inline-flex justify-center items-center ml-4">
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            <!-- Add respRay Form -->
            <div class="m-4">
                <h1 class="font-bold text-xl pb-4 px-4">ADD Responsable Rayon</h1>
                <div class="flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
                    <div class="relative rounded-t mb-0 px-0 border-0">
                        <div class="p-6">
                            <form action="addrespray.ad" method="POST">
