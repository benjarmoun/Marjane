...
<div x-data="setup()" :class="{ 'dark': isDark }">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2">
    ...
    <form class="p-6 flex flex-col justify-center" action="loginsup.sup" method="post">
<%--      <div class="flex flex-col">--%>
<%--        <label for="email" class="hidden">Full Name</label>--%>
<%--        <input type="email" name="email" id="email" placeholder="Full Name" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none" />--%>
<%--      </div>--%>
      ...
      <div class="flex flex-col mt-2">
        <label for="password" class="hidden">Number</label>
