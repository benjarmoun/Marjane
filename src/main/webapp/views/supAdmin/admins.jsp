...
<div x-data="setup()" :class="{ 'dark': isDark }">
  <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
    ...
    <div class="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
      <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <a href="admins.sup" class="relative flex flex-row items-center h-11 focus:outline-none bg-blue-800 dark:bg-gray-600  hover:text-white-800 border-l-4 border-transparent border-blue-500 dark:border-gray-800 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
      ...
      <h1 class="font-bold text-xl p-5 pt-4 pb-0">ADMINs</h1>
...
<%--                <th class="px-4 py-3">Action</th>--%>
              ...
              <c:forEach items="${admins}" var="admin">
                ...
                <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                  <td class="px-4 py-3 text-sm font-bold">${admin.getId()}</td>
                  <td class="px-4 py-3 text-sm">${admin.getEmail()}</td>
                  <td class="px-4 py-3"><p class="">Marjane ${admin.getStoreByStoreId().getStoreName()}</p></td>
                </tr>
              </c:forEach>
