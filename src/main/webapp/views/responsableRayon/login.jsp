...
<style>
    .login_img_section {
        background: url(https://www.laverite.ma/wp-content/uploads/2020/04/maxresdefault-1.jpg) center center ;
    }
</style>
<div class="h-screen flex">
    <div class="hidden lg:flex w-full lg:w-1/2 login_img_section
          justify-around items-center">
        <%--        <div class="bg-blackopacity-20inset-0z-0">--%>
        <%--        </div>--%>
    ...
    <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
        <div class="w-full px-8 md:px-32 lg:px-24">
            <form class="bg-white rounded-md shadow-2xl p-5" action="login.rr" method="post">
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Welcome Back!</h1>
                <h3 class="text-sm font-normal text-gray-600 mb-8">RESPONSABLE RAYON</h3>
